...
import org.firstinspires.ftc.teamcode.common.commandbase.teleopcommand.EndEffectorToggleCommand;
...
//    private boolean lastJoystickDownLeft = false;
    ...
    public void initialize() {
        ...
        gamepadEx.getGamepadButton(GamepadKeys.Button.RIGHT_BUMPER)
                .whenPressed(new EndEffectorToggleCommand(robot, ClawSide.LEFT));
        gamepadEx.getGamepadButton(GamepadKeys.Button.LEFT_BUMPER)
                .whenPressed(new EndEffectorToggleCommand(robot, ClawSide.RIGHT));
...
//        boolean currentJoystickDownLeft = gamepad2.left_stick_y > 0.5;
        ...
        if (currentJoystickDownRight && !lastJoystickDownRight) {
            CommandScheduler.getInstance().schedule(new IntakeExtendCommand(robot, -1));
