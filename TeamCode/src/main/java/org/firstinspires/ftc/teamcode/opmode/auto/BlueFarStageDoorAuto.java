...
@Config
@Autonomous(name = "🔵 Blue Far Stage Door Auto")
public class BlueFarStageDoorAuto extends LinearOpMode {
...
//        randomization = Location.RIGHT;
        ...
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        new EndEffectorCommand(IntakeSubsystem.ClawState.CLOSED, (Globals.ALLIANCE == Location.BLUE ? ClawSide.LEFT : ClawSide.RIGHT)),
